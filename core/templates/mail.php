...
<?php
print_unescaped($l->t("Hello,<br><br>we inform you that %s shared <strong>%s</strong> with you.<br><a href=\"%s\">View file</a><br><br>", array($_['user_displayname'], $_['filename'], $_['link'])));
